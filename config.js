...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://telegra.ph/file/f1ae2cd1d9d934d9c2465.jpg" ; // SET LOGO FOR IMAGE 
...
module.exports = {
  ...
  caption : process.env.CAPTION || "©𝐂𝚫𝚻 𝐒𝚸𝐘" , // ```『 ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝛭𝑈𝛨𝛥𝛭𝛭𝛯𝐷 』```", //*『sᴜʙsᴄʀɪʙᴇ • 𝛭𝑈𝛨𝛥𝛭𝛭𝛯𝐷』*"),
